...
<body>
                ...
                <div class="row">
                    <div class="col-lg-offset-2 col-lg-8 col-md-offset-3 col-md-6" col-xs-12>
                        <form id="formulario" role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Texto Izquierdo <em style="font-size: 10px;">(fondo azul, Ej.: Lunes 20 de Abril 2015)</em></label>
                                <input class="form-control" placeholder="Ingrese un Texto" id="txtTextoBarraAzul1" name="txtTextoBarraAzul1" >
                            </div>
                            <div class="form-group">
                                <label>Texto Centrado <em style="font-size: 10px;">(fondo azul, Ej.: 10:30 am)</em></label>
                                <input class="form-control" placeholder="Ingrese un Texto" id="txtTextoBarraAzul2" name="txtTextoBarraAzul2" >
                            </div>
                            <div class="form-group">
                                <label>Texto Derecho <em style="font-size: 10px;">(fondo azul, Ej.: Sala: Andrés Bello II)</em></label>
                                <input class="form-control" placeholder="Ingrese un Texto" id="txtTextoBarraAzul3" name="txtTextoBarraAzul3" >
                            </div>
                            <div class="form-group">
                                <label>Imagen <em style="font-size: 10px;">(Tamaño ideal Ancho 600px y 162px de Alto)</em></label>
                            ...
                            <div class="form-group">
                                <label>Publicar en forma de Columnas: </label>&nbsp;&nbsp;&nbsp;
                                <input type="checkbox" value="1" id="chkColumna" name="chkColumna" autofocus>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Descripcion Final <em style="font-size: 10px;">(debajo de los modulos)</em></label>
                                <textarea rows="5" class="form-control" placeholder="Ingrese un Texto" id="txtDescripcionFinal" name="txtDescripcionFinal" ></textarea>
                            </div>
                            
                            <div class="form-group">
                                <label>Comentario Final <em style="font-size: 10px;">(texto en rojo, Ej.: SE SERVIRÁ UN ALMUERZO LIGERO)</em></label>
                                <textarea rows="5" class="form-control" placeholder="Ingrese un Texto" id="txtComentarioFinal" name="txtComentarioFinal" ></textarea>
                            </div>
    ...
    <script type="text/javascript" src="prog/app/mcc/controladores/bo.altaNewsletter.cont.js"></script>
