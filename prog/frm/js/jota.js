...
Jota= function() {
    return {
                    ...
                    $.ajax({
                            ...
                            success: function(respuesta){
                                    ...
                                    $.each(respuesta, function(val, text) {
                                        ...
                                        $(objeto).append("<option value='"+val.replace("@@@","")+"'>"+text+"</option>");
                                    });
        ...
        ui: {
            ...
            {
                var opt = jQuery.extend( {sImgPath: 'img/ajax-loader.gif'}, opciones);
            ...
            {
                $(sSelector).css('position', 'absolute').css('width','10%').css('top','50%').css('left','50%').css('margin-top','-'+($(sSelector).height()/8+ 'px')).css('margin-left','-'+($(sSelector).width()/8+ 'px')).parent().css('position', 'relative').css('text-align', 'center');
            },
