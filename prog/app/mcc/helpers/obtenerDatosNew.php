                ...
                <div class="row" id="info_'.$i.'">
                    <div class="col-lg-11">
                        <div class="form-group">
                            <input class="form-control" placeholder="Titulo" id="txtTitulo_'.$i.'" name="txtTitulo_'.$i.'"  autofocus value="'.$modulos[$i]->getTitulo().'">
                        </div>
                    </div>
                    <div class="col-lg-1">
                        <div class="form-group">
                    ...
                    <div class="col-lg-11">
                        <div class="form-group">
                            <input class="form-control" placeholder="Titulo Nota" id="txtTituloNota_'.$i.'" name="txtTituloNota_'.$i.'"  autofocus value="'.$modulos[$i]->getTituloNota().'">
                        </div>
                    </div>
                    <div class="col-lg-11">
                        <div class="form-group">
