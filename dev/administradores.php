<?php
    ...
    $paginaResultados = 'prog/app/mcc/modelos/bo.abmUsuariosBo.mod.php';
    $paginaAltaEditar="altaAdministrador.php";
    $paginaActual="administradores.php";
?>
<!DOCTYPE html>
                                        ...
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="data in filtered = (list| filter:search | orderBy : predicate :reverse) | startFrom:(currentPage - 1) * entryLimit | limitTo:entryLimit">
                                                    ...
                                                    <td>{{data.Clave}}</td>
                                                    <td align="center">
                                                        <a href="<?php echo $paginaAltaEditar;?>?id={{data.IDUsuario}}&oper=edit" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i> Editar</a>
                                                        &nbsp;&nbsp;
                                                        <button class="btn btn-xs btn-danger" type="button" data-url-eliminar="<?php echo $paginaActual;?>" data-id-eliminar="{{data.IDUsuario}}" data-toggle="modal" data-target="#confirmDelete" data-title="Eliminar" data-message="Esta seguro que quiere eliminar el registro?"><i class="fa fa-trash-o"></i> Eliminar</button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
